...
class Seedance20PromptEnhancerTests(unittest.TestCase):
    ...
    def test_configured_local_template_library_serves_all_277_human_only_gifs(self):
        ...
        self.assertEqual(len(case_previews), 275)
    ...
    def test_github_checkout_serves_all_277_bundled_gifs_without_local_manifests(self):
        with (
            ...
            self.assertEqual(catalog["bundled_preview_count"], 277)
            self.assertTrue(all(preview["available"] for preview in previews))
    ...
    def test_bundled_gif_manifest_is_complete_hash_pinned_and_reasonably_sized(self):
        ...
        self.assertEqual(manifest["preview_count"], 277)
