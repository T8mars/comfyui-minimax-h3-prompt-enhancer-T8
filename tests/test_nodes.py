...
class PromptEnhancerTests(unittest.TestCase):
    ...
    def test_distributable_case_catalog_contains_only_active_text_abstractions(self):
        ...
        self.assertEqual(catalog["source_case_count"], 315)
        ...
        self.assertEqual(catalog["evidence_variant_count"], 102)
        ...
        self.assertEqual(preview_count, 317)
        ...
        self.assertEqual(len(by_id["t8c001-product-proof-state-machine"]["previews"]), 8)
        ...
        self.assertEqual(len(by_id["t8-case-character-action-typography-module-carousel-v1"]["previews"]), 7)
