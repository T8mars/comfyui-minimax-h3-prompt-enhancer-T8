...
class PromptEnhancerTests(unittest.TestCase):
    ...
    def test_distributable_case_catalog_contains_only_active_text_abstractions(self):
        ...
        self.assertEqual(catalog["source_case_count"], 335)
        ...
        self.assertEqual(catalog["evidence_variant_count"], 122)
        ...
        self.assertEqual(preview_count, 337)
        ...
        self.assertEqual(len(by_id["t8c001-product-proof-state-machine"]["previews"]), 9)
        self.assertEqual(len(by_id["t8-case-imperfect-memory-farewell-v1"]["previews"]), 3)
        self.assertEqual(len(by_id["t8-case-flat-geometry-reconstruction-v1"]["previews"]), 5)
        self.assertEqual(len(by_id["t8-case-recurring-identity-board-v1"]["previews"]), 7)
        ...
        self.assertEqual(len(by_id["t8-case-character-action-typography-module-carousel-v1"]["previews"]), 9)
