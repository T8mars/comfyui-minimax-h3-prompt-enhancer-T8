...
class PromptEnhancerTests(unittest.TestCase):
    ...
    def test_distributable_case_catalog_contains_only_active_text_abstractions(self):
        ...
        self.assertEqual(catalog["source_case_count"], 295)
        ...
        self.assertEqual(catalog["evidence_variant_count"], 82)
        ...
        self.assertEqual(preview_count, 297)
        ...
        self.assertEqual(len(by_id["t8c001-product-proof-state-machine"]["previews"]), 7)
        ...
        self.assertEqual(len(by_id["t8-case-character-action-typography-module-carousel-v1"]["previews"]), 6)
