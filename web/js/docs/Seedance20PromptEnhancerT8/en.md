...
- Accepts text, images, and videos. Local GGUF models use visual frame samples and do not read audio tracks.
- Local models are discovered recursively below `ComfyUI/models/LLM`; AUTO can pair a compatible mmproj for vision.
